...
{
    public class Girl2 : AnimatedObject, ICollidable
    {
        public Girl2(Texture2D spritesheet, Dictionary<string, Rectangle> map, Vector2 scale) : base(spritesheet, map, scale)
        {
