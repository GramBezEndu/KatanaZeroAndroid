...
{
    public class Guy1 : AnimatedObject, ICollidable
    {
        public Guy1(Texture2D spritesheet, Dictionary<string, Rectangle> map, Vector2 scale) : base(spritesheet, map, scale)
        {
